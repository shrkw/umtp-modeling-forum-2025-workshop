...
class AvailabilityTableTest < Minitest::Test
  def test_finalize_result_returns_best_date_and_score
    ...
    table.add(Participant.new('Alice', role: Roles::Required.new), [['2024-07-01', '⚪︎'], ['2024-07-02', 'x']])
    table.add(Participant.new('Bob', role: Roles::Optional.new), [['2024-07-01', '△'], ['2024-07-02', '⚪︎']])
  ...
  def test_ignores_slots_not_in_allowed_dates
    ...
    table.add(Participant.new('Alice', role: Roles::Optional.new), [['2024-07-02', '⚪︎']])
